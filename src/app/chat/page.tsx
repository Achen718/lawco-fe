...
const mockKeyTerminology = [
  {
    title:
      "Comprehensive hackathon-ready documentation requires structured analysis.",
    context: "Click to view in context",
  },
  {
    title:
      "Technical stack integration involves multiple API endpoints and data processing pipelines.",
    context: "Click to view in context",
  },
  {
    title:
      "Notion page formatting utilizes embeddable visual components for enhanced readability.",
    context: "Click to view in context",
  },
];
